...
using VSoft.Company.ANW.Anwser.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.ANW.Anwser.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestAnwserReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MAnwserEntity()
        {
            Id= id,
            //Name= fullName,
            //Phone= phone,
