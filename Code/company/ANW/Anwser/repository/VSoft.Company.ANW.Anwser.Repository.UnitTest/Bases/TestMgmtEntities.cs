...
using Model = VSoft.Company.ANW.Anwser.Data.Entity.Models.MAnwserEntity;

namespace VSoft.Company.ANW.Anwser.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<AnwserDbContext, IAnwserRepository, Model>
{
    ...
    {
        await RunTest("TestAddAnwser", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateAnwser", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelAnwser", async (r, l) =>
        {
