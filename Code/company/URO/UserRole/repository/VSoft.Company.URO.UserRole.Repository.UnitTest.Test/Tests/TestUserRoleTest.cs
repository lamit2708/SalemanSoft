...
using VSoft.Company.URO.UserRole.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.URO.UserRole.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestUserRoleTest : TestMgmtEntities
{
