...
using VSoft.Company.ORD.Order.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.ORD.Order.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestOrderTest : TestMgmtEntities
{
