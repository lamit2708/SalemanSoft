...
using VSoft.Company.ORD.Order.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.ORD.Order.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestOrderReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MOrderEntity()
        {
            Id= id,
        });
    }
