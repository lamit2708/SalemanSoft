...
using VSoft.Company.TEA.Team.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.TEA.Team.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestTeamReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MTeamEntity()
        {
            Id= id,
            //Name= fullName,
            //Phone= phone,
