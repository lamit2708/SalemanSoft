...
using Model = VSoft.Company.TEA.Team.Data.Entity.Models.MTeamEntity;

namespace VSoft.Company.TEA.Team.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<TeamDbContext, ITeamRepository, Model>
{
    ...
    {
        await RunTest("TestAddTeam", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateTeam", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelTeam", async (r, l) =>
        {
