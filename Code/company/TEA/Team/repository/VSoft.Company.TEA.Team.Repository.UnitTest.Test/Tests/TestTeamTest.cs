...
using VSoft.Company.TEA.Team.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.TEA.Team.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestTeamTest : TestMgmtEntities
{
