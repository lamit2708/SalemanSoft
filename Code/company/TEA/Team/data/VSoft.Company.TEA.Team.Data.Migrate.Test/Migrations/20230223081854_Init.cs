...
namespace VSoft.Company.TEA.Team.Data.Migrate.Test.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_TeamInfo_TO_Team",
                table: "Team",
                column: "TeamInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_Team",
                table: "Team",
                column: "PriorityId");
