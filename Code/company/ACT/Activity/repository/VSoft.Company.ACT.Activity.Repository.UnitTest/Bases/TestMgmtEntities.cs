...
using Model = VSoft.Company.ACT.Activity.Data.Entity.Models.MActivityEntity;

namespace VSoft.Company.ACT.Activity.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<ActivityDbContext, IActivityRepository, Model>
{
    ...
    {
        await RunTest("TestAddActivity", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateActivity", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelActivity", async (r, l) =>
        {
