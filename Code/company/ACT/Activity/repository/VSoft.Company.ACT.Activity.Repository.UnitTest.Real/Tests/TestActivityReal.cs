...
using VSoft.Company.ACT.Activity.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.ACT.Activity.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestActivityReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MActivityEntity()
        {
            Id= id,
            Name= fullName,
            //Phone= phone,
