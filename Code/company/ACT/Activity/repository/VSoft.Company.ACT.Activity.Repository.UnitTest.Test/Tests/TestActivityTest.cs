...
using VSoft.Company.ACT.Activity.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.ACT.Activity.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestActivityTest : TestMgmtEntities
{
