...
namespace VSoft.Company.ACT.Activity.Data.Migrate.Test.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_ActivityInfo_TO_Activity",
                table: "Activity",
                column: "ActivityInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_Activity",
                table: "Activity",
                column: "PriorityId");
