        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DealStepInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_DealStepInfo_TO_DealStep",
                table: "DealStep",
                column: "DealStepInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_DealStep",
                table: "DealStep",
                column: "PriorityId");
