...
using Model = VSoft.Company.DST.DealStep.Data.Entity.Models.MDealStepEntity;

namespace VSoft.Company.DST.DealStep.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<DealStepDbContext, IDealStepRepository, Model>
{
    ...
    {
        await RunTest("TestAddDealStep", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateDealStep", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelDealStep", async (r, l) =>
        {
