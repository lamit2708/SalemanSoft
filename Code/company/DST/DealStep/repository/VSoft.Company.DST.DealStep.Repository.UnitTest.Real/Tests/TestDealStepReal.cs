...
using VSoft.Company.DST.DealStep.Repository.UnitTest.Bases;
using VSoft.Company.DST.DealStep.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.DST.DealStep.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestDealStepReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MDealStepEntity()
        {
            Id= id,
            Name= fullName,
            //Phone= phone,
