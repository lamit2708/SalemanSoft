...
using VSoft.Company.DST.DealStep.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.DST.DealStep.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestDealStepTest : TestMgmtEntities
{
