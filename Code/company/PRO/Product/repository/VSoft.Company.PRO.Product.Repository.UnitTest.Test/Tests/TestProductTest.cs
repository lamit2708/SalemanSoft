...
using VSoft.Company.PRO.Product.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.PRO.Product.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestProductTest : TestMgmtEntities
{
