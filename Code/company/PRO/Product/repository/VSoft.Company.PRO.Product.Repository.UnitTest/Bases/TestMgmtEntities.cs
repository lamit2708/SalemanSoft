...
using Model = VSoft.Company.PRO.Product.Data.Entity.Models.MProductEntity;

namespace VSoft.Company.PRO.Product.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<ProductDbContext, IProductRepository, Model>
{
    ...
    {
        await RunTest("TestAddProduct", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateProduct", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelProduct", async (r, l) =>
        {
