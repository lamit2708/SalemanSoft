...
namespace VSoft.Company.PRO.Product.Data.Migrate.Test.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_ProductInfo_TO_Product",
                table: "Product",
                column: "ProductInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_Product",
                table: "Product",
                column: "PriorityId");
