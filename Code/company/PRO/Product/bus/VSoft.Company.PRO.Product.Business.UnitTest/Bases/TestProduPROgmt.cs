...
{
    public class TestProductMgmt : BusinessTest<Model>
    {
        ...
        protected override void RegisterServices()
        {
            ...
            ServiceCollection?.AddScoped<IProductMgmtBus, ProductMgmtBus>();
        }
        ...
        protected async Task TestGetFullNameByIdAsync(MDtoRequestFindByInt dto)
        {
            ...
            {
                var bus = GetService<IProductMgmtBus>();
                if (bus == null) return;
        ...
        protected async Task TestSaveRangeTransactionAsync(ProductSaveRangeDtoRequest? request)
        {
            await RunTest("TestSaveRangeAsync", async (log) =>
            {
                var createDtos = request?.CreateData;
