...
using VSoft.Company.PRI.Priority.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.PRI.Priority.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestPriorityTest : TestMgmtEntities
{
