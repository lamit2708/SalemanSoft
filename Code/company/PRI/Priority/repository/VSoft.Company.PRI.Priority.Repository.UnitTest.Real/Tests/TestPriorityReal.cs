...
using VSoft.Company.PRI.Priority.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.PRI.Priority.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestPriorityReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MPriorityEntity()
        {
            Id= id,
            Name= fullName,
            //Phone= phone,
