...
using VSoft.Company.ROL.Role.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.ROL.Role.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestRoleReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MRoleEntity()
        {
            Id= id,
            Name= fullName,
            //Phone= phone,
