...
using VSoft.Company.ROL.Role.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.ROL.Role.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestRoleTest : TestMgmtEntities
{
