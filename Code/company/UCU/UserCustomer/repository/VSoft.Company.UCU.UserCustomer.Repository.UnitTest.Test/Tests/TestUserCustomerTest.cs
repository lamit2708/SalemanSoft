...
using VSoft.Company.UCU.UserCustomer.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.UCU.UserCustomer.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestUserCustomerTest : TestMgmtEntities
{
