...
using VSoft.Company.UCU.UserCustomer.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.UCU.UserCustomer.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestUserCustomerReal : TestMgmtEntities
{
