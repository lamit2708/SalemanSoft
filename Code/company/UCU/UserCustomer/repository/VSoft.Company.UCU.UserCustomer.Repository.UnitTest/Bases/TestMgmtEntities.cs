...
using Model = VSoft.Company.UCU.UserCustomer.Data.Entity.Models.MUserCustomerEntity;

namespace VSoft.Company.UCU.UserCustomer.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<UserCustomerDbContext, IUserCustomerRepository, Model>
{
    ...
    {
        await RunTest("TestUpdateUserCustomer", async (r, l) =>
        {
