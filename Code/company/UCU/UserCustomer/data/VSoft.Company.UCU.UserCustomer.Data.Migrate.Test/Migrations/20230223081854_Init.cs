        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserCustomerInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_UserCustomerInfo_TO_UserCustomer",
                table: "UserCustomer",
                column: "UserCustomerInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_UserCustomer",
                table: "UserCustomer",
                column: "PriorityId");
