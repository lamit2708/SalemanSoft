...
using VSoft.Company.DSH.DealStepHistory.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.DSH.DealStepHistory.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestDealStepHistoryTest : TestMgmtEntities
{
