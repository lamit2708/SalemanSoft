...
using Model = VSoft.Company.DSH.DealStepHistory.Data.Entity.Models.MDealStepHistoryEntity;

namespace VSoft.Company.DSH.DealStepHistory.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<DealStepHistoryDbContext, IDealStepHistoryRepository, Model>
{
    ...
    {
        await RunTest("TestAddDealStepHistory", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateDealStepHistory", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelDealStepHistory", async (r, l) =>
        {
