...
using VSoft.Company.DSH.DealStepHistory.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.DSH.DealStepHistory.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestDealStepHistoryReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MDealStepHistoryEntity()
        {
            Id= id,
            //Name= fullName,
            //Phone= phone,
