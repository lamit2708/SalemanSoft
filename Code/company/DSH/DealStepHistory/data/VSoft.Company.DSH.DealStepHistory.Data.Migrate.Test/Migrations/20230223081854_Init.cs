...
namespace VSoft.Company.DSH.DealStepHistory.Data.Migrate.Test.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DealStepHistoryInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_DealStepHistoryInfo_TO_DealStepHistory",
                table: "DealStepHistory",
                column: "DealStepHistoryInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_DealStepHistory",
                table: "DealStepHistory",
                column: "PriorityId");
