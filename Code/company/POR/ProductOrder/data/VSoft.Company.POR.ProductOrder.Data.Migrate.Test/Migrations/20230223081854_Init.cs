        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductOrderInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_ProductOrderInfo_TO_ProductOrder",
                table: "ProductOrder",
                column: "ProductOrderInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_ProductOrder",
                table: "ProductOrder",
                column: "PriorityId");
