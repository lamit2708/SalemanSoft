...
using VSoft.Company.POR.ProductOrder.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.POR.ProductOrder.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestProductOrderTest : TestMgmtEntities
{
