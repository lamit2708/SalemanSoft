...
using VSoft.Company.POR.ProductOrder.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.POR.ProductOrder.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestProductOrderReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MProductOrderEntity()
        {
            Id= id,
            //Name= fullName,
            //Phone= phone,
