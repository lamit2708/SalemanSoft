...
using Model = VSoft.Company.DEA.Deal.Data.Entity.Models.MDealEntity;

namespace VSoft.Company.DEA.Deal.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<DealDbContext, IDealRepository, Model>
{
    ...
    {
        await RunTest("TestAddDeal", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateDeal", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelDeal", async (r, l) =>
        {
