...
using VSoft.Company.DEA.Deal.Repository.UnitTest.Bases;
using VSoft.Company.DEA.Deal.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.DEA.Deal.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestDealReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MDealEntity()
        {
            Id= id,
            Name= fullName,
        });
