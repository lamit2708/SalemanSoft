...
using VSoft.Company.DEA.Deal.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.DEA.Deal.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestDealTest : TestMgmtEntities
{
