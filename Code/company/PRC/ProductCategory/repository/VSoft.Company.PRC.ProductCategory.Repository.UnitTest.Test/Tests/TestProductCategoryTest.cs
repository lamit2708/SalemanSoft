...
using VSoft.Company.PRC.ProductCategory.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.PRC.ProductCategory.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestProductCategoryTest : TestMgmtEntities
{
