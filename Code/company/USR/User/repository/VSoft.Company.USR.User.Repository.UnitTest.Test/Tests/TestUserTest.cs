...
using VSoft.Company.USR.User.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.USR.User.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestUserTest : TestMgmtEntities
{
