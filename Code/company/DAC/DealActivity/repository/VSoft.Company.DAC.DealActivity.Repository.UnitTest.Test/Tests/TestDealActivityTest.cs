...
using VSoft.Company.DAC.DealActivity.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.DAC.DealActivity.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestDealActivityTest : TestMgmtEntities
{
