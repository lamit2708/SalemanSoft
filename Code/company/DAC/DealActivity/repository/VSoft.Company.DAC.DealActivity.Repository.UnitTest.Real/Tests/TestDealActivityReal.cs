...
using VSoft.Company.DAC.DealActivity.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.DAC.DealActivity.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestDealActivityReal : TestMgmtEntities
{
