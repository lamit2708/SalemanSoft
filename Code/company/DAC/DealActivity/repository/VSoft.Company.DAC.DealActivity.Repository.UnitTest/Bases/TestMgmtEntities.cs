...
using Model = VSoft.Company.DAC.DealActivity.Data.Entity.Models.MDealActivityEntity;

namespace VSoft.Company.DAC.DealActivity.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<DealActivityDbContext, IDealActivityRepository, Model>
{
    ...
    {
        await RunTest("TestUpdateDealActivity", async (r, l) =>
        {
