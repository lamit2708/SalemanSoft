        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomerInfoInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_CustomerInfoInfo_TO_CustomerInfo",
                table: "CustomerInfo",
                column: "CustomerInfoInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_CustomerInfo",
                table: "CustomerInfo",
                column: "PriorityId");
