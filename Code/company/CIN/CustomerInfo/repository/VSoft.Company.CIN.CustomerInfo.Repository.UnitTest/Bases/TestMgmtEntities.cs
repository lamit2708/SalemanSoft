...
using Model = VSoft.Company.CIN.CustomerInfo.Data.Entity.Models.MCustomerInfoEntity;

namespace VSoft.Company.CIN.CustomerInfo.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<CustomerInfoDbContext, ICustomerInfoRepository, Model>
{
    ...
    {
        await RunTest("TestAddCustomerInfo", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateCustomerInfo", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelCustomerInfo", async (r, l) =>
        {
