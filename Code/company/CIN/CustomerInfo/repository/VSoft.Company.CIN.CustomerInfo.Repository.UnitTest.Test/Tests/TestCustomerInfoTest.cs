...
using VSoft.Company.CIN.CustomerInfo.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.CIN.CustomerInfo.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestCustomerInfoTest : TestMgmtEntities
{
