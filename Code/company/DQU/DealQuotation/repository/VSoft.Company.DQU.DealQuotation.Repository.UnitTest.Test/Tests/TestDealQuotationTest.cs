...
using VSoft.Company.DQU.DealQuotation.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.DQU.DealQuotation.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestDealQuotationTest : TestMgmtEntities
{
