...
using VSoft.Company.DQU.DealQuotation.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.DQU.DealQuotation.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestDealQuotationReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MDealQuotationEntity()
        {
            Id= id,
            //Name= fullName,
            //Phone= phone,
