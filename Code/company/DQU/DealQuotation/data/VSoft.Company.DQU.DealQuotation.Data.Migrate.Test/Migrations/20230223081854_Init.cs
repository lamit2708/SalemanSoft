...
namespace VSoft.Company.DQU.DealQuotation.Data.Migrate.Test.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DealQuotationInfoId = table.Column<long>(type: "bigint(20)", nullable: true, defaultValueSql: "'NULL'"),
            ...
            migrationBuilder.CreateIndex(
                name: "FK_DealQuotationInfo_TO_DealQuotation",
                table: "DealQuotation",
                column: "DealQuotationInfoId");

            migrationBuilder.CreateIndex(
                name: "FK_Priority_TO_DealQuotation",
                table: "DealQuotation",
                column: "PriorityId");
