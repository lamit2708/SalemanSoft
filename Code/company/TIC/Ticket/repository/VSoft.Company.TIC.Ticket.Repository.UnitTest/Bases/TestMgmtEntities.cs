...
using Model = VSoft.Company.TIC.Ticket.Data.Entity.Models.MTicketEntity;

namespace VSoft.Company.TIC.Ticket.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<TicketDbContext, ITicketRepository, Model>
{
    ...
    {
        await RunTest("TestAddTicket", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateTicket", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelTicket", async (r, l) =>
        {
