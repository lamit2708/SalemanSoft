...
using VSoft.Company.TIC.Ticket.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.TIC.Ticket.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestTicketReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MTicketEntity()
        {
            Id= id,
            Name= fullName,
            //Phone= phone,
