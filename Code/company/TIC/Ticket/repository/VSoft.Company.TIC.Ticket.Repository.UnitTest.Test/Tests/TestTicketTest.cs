...
using VSoft.Company.TIC.Ticket.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.TIC.Ticket.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestTicketTest : TestMgmtEntities
{
