...
using Model = VSoft.Company.CTM.Customer.Data.Entity.Models.MCustomerEntity;

namespace VSoft.Company.CTM.Customer.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<CustomerDbContext, ICustomerRepository, Model>
{
