...
using VSoft.Company.CSO.CustomerSource.Repository.UnitTest.Real.Values.GroupA;

namespace VSoft.Company.CSO.CustomerSource.Repository.UnitTest.Real.Tests;

[TestClass]
public class TestCustomerSourceReal : TestMgmtEntities
{
    ...
    {
        await TestUpdateAsync(new MCustomerSourceEntity()
        {
            Id= id,
            Name= fullName,
            //Phone= phone,
