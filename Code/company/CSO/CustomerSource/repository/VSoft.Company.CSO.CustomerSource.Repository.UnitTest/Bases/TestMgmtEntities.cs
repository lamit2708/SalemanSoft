...
using Model = VSoft.Company.CSO.CustomerSource.Data.Entity.Models.MCustomerSourceEntity;

namespace VSoft.Company.CSO.CustomerSource.Repository.UnitTest.Bases;


public class TestMgmtEntities : RepositoryTest<CustomerSourceDbContext, ICustomerSourceRepository, Model>
{
    ...
    {
        await RunTest("TestAddCustomerSource", async (r, l) =>
        {
    ...
    {
        await RunTest("TestUpdateCustomerSource", async (r, l) =>
        {
    ...
    {
        await RunTest("TestDelCustomerSource", async (r, l) =>
        {
