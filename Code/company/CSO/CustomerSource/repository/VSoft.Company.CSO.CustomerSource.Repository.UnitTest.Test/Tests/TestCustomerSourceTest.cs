...
using VSoft.Company.CSO.CustomerSource.Repository.UnitTest.Test.Values.GroupA;

namespace VSoft.Company.CSO.CustomerSource.Repository.UnitTest.Test.Tests;

[TestClass]
public class TestCustomerSourceTest : TestMgmtEntities
{
