...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 26, 2023 at 11:28 AM
...
(1, 'Tạo Deal', NULL),
(2, 'Lấy yêu cầu và phân tích', NULL),
(3, 'Tư vấn và demo', NULL),
(4, 'Báo giá', NULL),
(5, 'Đóng Deal', NULL);
...
INSERT INTO `order` (`Id`, `CustomerId`, `UserId`, `DealId`, `IsDraft`, `CreatedDate`, `EditedUserId`, `EditedDate`) VALUES
(1, 18, 1, NULL, 1, '2023-04-06 19:08:50', NULL, NULL);
...
INSERT INTO `productfeature` (`Id`, `Name`, `Description`, `Price`, `ProductId`) VALUES
(1, 'Tính tiền', 'Giúp nhân viên tính tiền, in hóa đơn', 10000000, 1),
(2, 'Quản lý hàng tồn kho', 'Giúp phân tích tồn kho, và tình hình kinh doanh theo thời gian (ERP)', 40000000, 1),
(3, 'Báo cáo tồn kho', 'Tự động phản ánh tăng giảm hàng hóa trong bán hàng, mua hàng, sản xuất và lưu kho', 30000000, 1),
(4, 'Quản lý sản phẩm', 'Giúp phân tích mối quan hệ giữa khách hàng và sản phẩm ví dụ dòng sản phẩm nào bán chạy, khách hàng có độ tuổi nào, khu vực nào, giới tính nào, trình độ học vấn ra sao(CRM)', 20000000, 2),
(5, 'Quản lý sản phẩm', 'Quản lý sản phẩm có mô hình giá, Tax, ship (EComerce)', 50000000, 3),
(6, 'Quản lý hàng tồn kho', 'Giúp phân tích tồn kho, và tình hình kinh doanh theo thời gian (ERP)', 0, 0),
(8, 'Quản lý hàng tồn kho', 'Giúp phân tích tồn kho, và tình hình kinh doanh theo thời gian (ERP)', 40000000, 1);
...
(1, 1, 3, NULL, '2023-04-25 19:40:11', '2023-04-25 19:40:11', 0),
(4, 1, 4, NULL, '2023-04-25 19:11:23', '2023-04-25 19:11:23', 0),
(5, 3, 3, NULL, '2023-04-25 19:11:52', '2023-04-25 19:11:52', 0),
(6, 3, 1, NULL, '2023-04-25 19:40:24', '2023-04-25 19:40:24', 0);
...
('20230423043532_InitProductFeature', '7.0.2'),
('20230423080814_InitFeature', '7.0.2'),
('20230425132524_InitOrder', '7.0.2');
