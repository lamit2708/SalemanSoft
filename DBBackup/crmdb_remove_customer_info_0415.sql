...
(1, 'Họp ngày thảo luận giá', 'Tập họp mọi người họp mặt', 'phone', '2023-04-25 00:00:00', '2023-04-12 00:00:00', '2023-04-14 00:00:00', 'aaa', NULL, '2023-04-11 20:29:44', 1);
...
(1, '2023-04-06 14:09:26', 18, 1, 1, NULL, 'Quản lý nhà hàng', 'Quản lý chuỗi nhà hàng du lịch', 200000000, '2023-06-30 19:56:27', 0),
(6, '2023-04-17 12:45:02', 1, 1, 1, NULL, 'Thiết kế quán cà phê', 'Quán cà phê quy mô 50 bàn, có hỗ trợ thức ăn nhẹ, cần quản lý kho và nhân viên', 120000000, '2023-07-13 12:45:02', 0),
(10, '2023-04-13 20:34:36', 1, 1, 1, NULL, 'Deal abc 1', 'abc', 100000000, '2023-04-13 20:34:20', 0);
...
(84, 'Hệ thống quản lý bệnh viện', 100000000, 1, 'Giúp quản lý bệnh viện', 2, 'He thong quan ly benh vien Giup quan ly benh vien');
...
(1, 'Team Sale Online', 'Khai thác khách hàng từ Facebook, Youtube, Google Ads'),
(2, 'Team Sale Offline', 'Khai thác khách hàng từ tổ chức sự kiện Marketing'),
(4, 'Team Sale Friend', 'Khai thác khách hàng trung thành và đối tác');
...
(5, 'Lê Vũ Lâm', '0911223333333', 'lamlv1', '�e�Y B/�A~Hg��O��J?��~������z�', 'lam@gmail.com', NULL);
...
('20230413115001_init', '7.0.2'),
('20230415091604_Init', '7.0.2'),
('20230415091854_CustomerInfo', '7.0.2'),
('20230415093845_init', '7.0.2');
