...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 25, 2023 at 02:37 PM
...
CREATE TABLE `order` (
  ...
  `IsQuotation` tinyint(1) NOT NULL DEFAULT 1,
  `CreatedDate` datetime DEFAULT NULL,
...
INSERT INTO `order` (`Id`, `CustomerId`, `UserId`, `DealId`, `IsQuotation`, `CreatedDate`, `EditedUserId`, `EditedDate`) VALUES
...
(6, 3, 3, NULL, '2023-04-25 19:11:53', '2023-04-25 19:11:53', 0);
